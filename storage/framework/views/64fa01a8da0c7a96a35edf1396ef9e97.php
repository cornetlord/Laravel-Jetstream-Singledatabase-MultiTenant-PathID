...
unset($__sessionArgs); ?>
        ...
        <form method="POST" action="<?php echo e(tenant('id') ? route('login', ['tenant' => tenant('id')]) : route('login')); ?>">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /Users/jameskenworthy/Sites/inspections/resources/views/auth/login.blade.php ENDPATH**/ ?>